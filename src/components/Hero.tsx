...
function Hero(){
    return(
   <section className="relative min-h-screen flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 md:gap-12 bg-cream px-8 md:px-16 max-w-6xl mx-auto">
      {/* Details */}
        ...
        <h1 className="font-heading text-4xl sm:text-5xl md:text-7xl font-bold text-deep-green leading-[0.95] tracking-tight">
            Joshua Cabatan
        </h1>
      ...
      <img
        src={headshot}
        alt="Joshua Cabatan"
       className="order-first md:order-none w-40 md:w-72 h-40 md:h-72 rounded-2xl object-cover border-4 border-deep-green"
      />
